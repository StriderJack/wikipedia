...
def get_entity_id(title):
	url_entity = 'https://www.wikidata.org/w/api.php?action=wbsearchentities&search={}&language=en&limit=1&format=json'.format(title)
...
def get_date_of_birth(entity_id):
	url_birth = 'https://www.wikidata.org/w/api.php?action=wbgetclaims&entity={}&property=P569&format=json'.format(entity_id)
...
def get_date_of_death(entity_id):
	url_death = 'https://www.wikidata.org/w/api.php?action=wbgetclaims&entity={}&property=P570&format=json'.format(entity_id)
